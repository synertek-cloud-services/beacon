...
**5. Patch Policy Class simplified to Server/Client OS + automatic Hyper-V host exclusion (PR pending, migration `0068`)**
...
3. **Land the pending Hyper-V exclusion PR** — code-complete and verified against local `wrangler dev`, not yet committed/PR'd as of this log entry.
