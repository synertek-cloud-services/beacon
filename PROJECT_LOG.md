...
| Network Discovery scoped but not built | Real per-company credential storage is a genuine prerequisite (needed to authenticate scans), and that feature doesn't exist yet — building Discovery first would mean building it against nothing. |
