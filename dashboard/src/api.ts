...
export const api = {
  ...
  devices: {
    ...
    commands: {
      ...
      create: (deviceId: string, body: { type: 'run_script' | 'reboot' | 'run_audit' | 'restart_agent' | 'force_update' | 'install_patches' | 'uninstall_agent' | 'manage_software'; shell?: string; script?: string; timeout_seconds?: number; update_ids?: string[]; package_ids?: string[] }) =>
