...
.pf-group-opt {
  padding: 8px 12px; font-size: 12px; color: var(--color-text-primary); cursor: pointer;
  transition: background .08s; display: flex; align-items: baseline; gap: 6px; flex-wrap: wrap;
}
.pf-group-opt:hover { background: var(--color-surface-raised); }
.pf-group-opt-id { font-size: 10px; color: var(--color-text-muted); }
.pf-group-opt-empty { padding: 10px 12px; font-size: 12px; color: var(--color-text-muted); }
</style>
