...
| Interactive remote shell | Unvalidated | Experimental | Unvalidated | Linux PTY code opened on a real agent, but the hosted Durable Object relay forwarded no traffic in either connection order; tracked in [#98](https://github.com/synertek-cloud-services/beacon/issues/98). |
