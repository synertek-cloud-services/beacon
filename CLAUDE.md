...
- **Not yet verified on real hardware** — designed and reasoned through carefully given the session-long pain around exactly this class of bug (self-referential stop/restart races), but not exercised on a live hardened install yet.
