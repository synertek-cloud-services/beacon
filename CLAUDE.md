...
Latest migration: `0082` (`devices.windows_installation_type`, see Patch Management's Hyper-V exclusion subsection). Check `migrations/` directly for the full ordered list; PROJECT_LOG.md has the session-by-session story for anything not covered here.
