...
const FINE_GRAINED: Record<string, FineGrainedEntry> = {
  ...
  'POST /v1/admin/policies/:id/companies':                    { action: 'Added policy company target', entityType: 'policy' },
  'DELETE /v1/admin/policies/:id/companies/:companyId':        { action: 'Removed policy company target', entityType: 'policy' },
