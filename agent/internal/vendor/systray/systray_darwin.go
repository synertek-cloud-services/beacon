...
// reAdd is a Beacon fork addition, only meaningfully implemented on Windows
// (see systray_windows.go's reAdd) -- macOS's NSStatusItem model doesn't
// have the equivalent blank-slot failure mode this exists to work around.
func reAdd() {}
